...
public class FileUtils {
    ...
    public static String writeImportBytes(byte[] data) throws IOException {
        return writeBytes(data, HangarConfig.getImportPath());
    }
    ...
    public static File multipartFileToFile(MultipartFile file) {
        ...
        try {
            if ("".equals(file) || file.getSize() <= 0) {
                ...
                String direUrl = HangarConfig.getProfile() + "/temp/";
                File fileOne = new File(direUrl);
                if (!fileOne.exists()) {
                    fileOne.mkdirs();
                }
                toFile = new File(direUrl + file.getOriginalFilename());
