package snegrid.move.hangar.utils.poi;
...
import snegrid.move.hangar.utils.file.FileTypeUtils;
import snegrid.move.hangar.utils.file.FileUtils;
import snegrid.move.hangar.utils.file.ImageUtils;
import snegrid.move.hangar.utils.reflect.ReflectUtils;
import snegrid.move.hangar.utils.text.Convert;
...
public class ExcelUtil<T> {
    ...
    public List<T> importExcel(String sheetName, InputStream is, int titleNum) throws Exception {
        ...
        if (rows > 0) {
            ...
            Map<Integer, Object[]> fieldsMap = new HashMap<Integer, Object[]>(fields.size());
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = HangarConfig.getDownloadPath() + filename;
